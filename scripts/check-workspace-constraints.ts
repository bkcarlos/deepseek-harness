...
const appPackageFiles: Readonly<Record<string, readonly string[]>> = {
  ...
  // The Electron shell ships the built renderer, the main/preload ESM, and
  // the shipped agent-preset root (the boot resolves it beside the app).
  '@deepseek-ai/dsh-desktop': ['dist', 'dist-electron', 'config'],
}
