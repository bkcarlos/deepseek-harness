...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/desktop-menu': { kind: 'none', reason: 'Browser-side native-menu dispatcher; registers nothing model-facing.' },
  ...
  'packages/client/ui-settings-update': { kind: 'none', reason: 'Browser-side desktop update controls; registers nothing model-facing.' },
  ...
  'packages/host/desktop': { kind: 'none', reason: 'The desktop transport bridge carries the shared /api gateway and registers nothing model-facing.' },
  ...
  'packages/bundle/desktop-app': { kind: 'indirect', reason: 'The desktop bundle is a patch-list carrier over the web surface; each inserted row\'s package owns its model-facing behavior.' },
