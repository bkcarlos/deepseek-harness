...
- `@deepseek-ai/dsh-client-desktop-menu`（[`packages/client/desktop-menu/src/index.ts`](../packages/client/desktop-menu/src/index.ts)）
...
- `@deepseek-ai/dsh-host-desktop` — 需要 `apiProxy` · `clientModules` · `connection`（[`packages/host/desktop/src/index.ts`](../packages/host/desktop/src/index.ts)）
